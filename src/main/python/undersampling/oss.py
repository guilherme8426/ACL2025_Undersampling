...
class OSS(InstanceSelectionMixin):
    ...
    def select_data(self, X, y):
        ...
        oss = OneSidedSelection(random_state=42, sampling_strategy=self.sampling_strategy)
        oss.fit_resample(X, y) #Pode retornar X, y que ficaram

        idx_s = oss.sample_indices_
