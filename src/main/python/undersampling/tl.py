...
class TL(InstanceSelectionMixin):
    """ Tomek Link (TL)
    Descrição:
    ==========
    ...
    def select_data(self, X, y):
        ...
        tl = TomekLinks(sampling_strategy=self.sampling_strategy)
        tl.fit_resample(X, y) #Pode retornar X, y que ficaram

        idx_s = tl.sample_indices_
