...
class NCR(InstanceSelectionMixin):
    ...
    def select_data(self, X, y):
        ...
        ncr = NeighbourhoodCleaningRule(sampling_strategy=self.sampling_strategy)
        ncr.fit_resample(X, y) #Pode retornar X, y que ficaram

        idx_s = ncr.sample_indices_
